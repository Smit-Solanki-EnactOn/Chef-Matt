            ...
            <div className="flex flex-col gap-8 sm:gap-10 md:gap-12 lg:gap-14 py-4">
                ...
                <div className='flex flex-col items-center gap-4 sm:gap-5 md:gap-6'>
                    ...
                    <div className='flex gap-3 sm:gap-4'>
                        <p className='text-white text-lg sm:text-xl md:text-2xl cursor-pointer hover:text-gold smooth-transition scale-up'><FaFacebook /></p>
                        <p className='text-white text-lg sm:text-xl md:text-2xl cursor-pointer hover:text-gold smooth-transition scale-up'><FaTwitter /></p>
                        <p className='text-white text-lg sm:text-xl md:text-2xl cursor-pointer hover:text-gold smooth-transition scale-up'><FaInstagram /></p>
                        <p className='text-white text-lg sm:text-xl md:text-2xl cursor-pointer hover:text-gold smooth-transition scale-up'><FaYoutube /></p>
                        <p className='text-white text-lg sm:text-xl md:text-2xl cursor-pointer hover:text-gold smooth-transition scale-up'><FaPinterest /></p>
                    </div>
                </div>
            </div>
