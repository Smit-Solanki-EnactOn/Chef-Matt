...
const Sidebar = () => {
    ...
    return (
        <motion.nav
            className='flex items-center h-auto md:h-screen p-2 sm:p-4 bg-overlay-background border-0 md:border-r-6 border-gold shrink-0'
            style={{ width: "100%" }}
            initial="closed"
        ...
        >
            ...
            <AnimatePresence>
                ...
                {isOpen &&
                    ...
                    >
                        <button onClick={closeSidebar} className='cursor-pointer self-start transform translate-y-2 md:translate-x-5'><ImCross className='text-white text-2xl sm:text-3xl md:text-4xl' /></button>
                        <motion.div
