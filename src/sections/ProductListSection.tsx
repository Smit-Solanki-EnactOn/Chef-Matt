      ...
      <div className="relative container mx-auto px-4">
        ...
        <div className="py-4 flex flex-col gap-8 sm:gap-12 md:gap-16 z-1 relative">
          ...
          >
            ...
            <button className="absolute left-0 sm:-left-2 md:-left-4 top-1/2 transform -translate-y-1/2 z-1 cursor-pointer button-prev" slot="button-prev">
              <img src={LeftArrow} alt="arrow-left" className='w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-15 lg:h-15' />
            </button>

            <button className="absolute right-0 sm:-right-2 md:-right-4 top-1/2 transform -translate-y-1/2 z-1 cursor-pointer button-next" slot="button-next">
